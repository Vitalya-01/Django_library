...
class AuthorCreateTest(TestCase):
    ...
    def test_form_date_of_death_initially_set_to_expected_date(self):
        ...
        expected_date_of_death = datetime.date(2016,10,12)
        resp_date = resp.context['form'].initial['date_of_death']
        resp_date = datetime.datetime.strptime(resp_date, '%d/%m/%Y').date()
        self.assertEqual(resp_date, expected_date_of_death)
